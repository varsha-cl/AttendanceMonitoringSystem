package com.example.varsha.attendance_monitoring_system.adapter;
 ...
 */
        ...
        import com.example.varsha.attendance_monitoring_system.R;
...
public class MyArrayAdapter extends ArrayAdapter<MyDataModel> {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        vh.textViewName.setText(item.getUsn());
        vh.textViewCountry.setText(item.getTime());
